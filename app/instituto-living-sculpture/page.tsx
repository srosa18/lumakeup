...
export default function InstitutoLivingSculpture() {
  ...
  return (
    <>
      {/* HERO sóbrio */}
      <div data-comment-id="instituto.hero" data-comment-label="Instituto Living Sculpture · Hero">
      ...
      {/* A CAUSA E A ORIGEM */}
      <div data-comment-id="instituto.origem" data-comment-label="Instituto Living Sculpture · Origem">
        <section aria-labelledby="origem-heading" data-section-theme="light" className="overflow-hidden bg-bone">
          <div className="mx-auto grid max-w-[1280px] lg:grid-cols-2">
            <div className="order-2 px-6 py-20 lg:order-1 lg:px-16 lg:py-32">
              ...
              <h2 id="origem-heading" className="mt-5 font-display text-[1.6rem] font-light leading-[1.18] text-text-on-bone sm:text-[2rem] sm:leading-[1.15] lg:text-[2.6rem]">
      ...
      {/* O TRABALHO */}
      <div data-comment-id="instituto.trabalho" data-comment-label="Instituto Living Sculpture · Trabalho">
      ...
      {/* OS PIGMENTOS */}
      <div data-comment-id="instituto.pigmentos" data-comment-label="Instituto Living Sculpture · Pigmentos">
      ...
      {/* ENCAMINHAMENTO / CTA */}
      <div data-comment-id="instituto.cta" data-comment-label="Instituto Living Sculpture · CTA">
