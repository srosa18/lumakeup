...
export default function TermosDeServico() {
  return (
    <>
      <div data-comment-id="termos.hero" data-comment-label="Termos de Serviço · Hero">
      ...
      <div data-comment-id="termos.conteudo" data-comment-label="Termos de Serviço · Conteúdo">
