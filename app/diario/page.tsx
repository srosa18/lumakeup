...
export default function DiarioIndex() {
  ...
  return (
    <>
      {/* Intro */}
      <div data-comment-id="diario.hero" data-comment-label="Diário · Hero">
      ...
      <div data-comment-id="diario.destaque" data-comment-label="Diário · Destaque">
        {destaque && (
      ...
      {/* Grade dos demais */}
      <div data-comment-id="diario.grade" data-comment-label="Diário · Grade de posts">
