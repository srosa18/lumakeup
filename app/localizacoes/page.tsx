...
export default function LocalizacoesIndex() {
  return (
    <>
      <div data-comment-id="localizacoes.hero" data-comment-label="Localizações · Hero">
      ...
      <div data-comment-id="localizacoes.unidades" data-comment-label="Localizações · Unidades">
