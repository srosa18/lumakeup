...
export default function ACasa() {
  ...
  return (
    <>
      {/* HERO full-bleed */}
      <div data-comment-id="a-casa.hero" data-comment-label="A Casa · Hero">
      ...
      {/* MANIFESTO / História */}
      <div data-comment-id="a-casa.historia" data-comment-label="A Casa · História">
      ...
      {/* FUNDADORA */}
      <div data-comment-id="a-casa.fundadora" data-comment-label="A Casa · Fundadora">
      ...
      {/* O MÉTODO + EQUIPE */}
      <div data-comment-id="a-casa.metodo" data-comment-label="A Casa · Método">
      ...
      {/* PIGMENTOS */}
      <div data-comment-id="a-casa.pigmentos" data-comment-label="A Casa · Pigmentos">
      ...
      {/* O ESPAÇO */}
      <div data-comment-id="a-casa.espaco" data-comment-label="A Casa · Espaço">
      ...
      {/* CTA */}
      <div data-comment-id="a-casa.cta" data-comment-label="A Casa · CTA">
